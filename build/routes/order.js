...
//user
exports.orderRouter.post("/api/v1/user/order/create", extractUserJWT_1.default, order_1.default.addOrder);
exports.orderRouter.put("/api/v1/user/order/cancel/:order_id", extractUserJWT_1.default, order_1.default.cancelOrder);
exports.orderRouter.get("/api/v1/user/order/get/:customer_id", extractUserJWT_1.default, order_1.default.getUserOrders);
