...
exports.customerRouter.put("/api/v1/user/customer/update/:id", extractCustomerJWT_1.default, extractRequest_1.extractRequest(user_1.userUpdateSchema), extractCustomerJWT_1.default, uploadImage_1.upload.single("image"), customer_1.default.updateUser);
