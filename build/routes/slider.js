...
exports.sliderRouter.get('/api/v1/admin/slider/get', extractAdminJWT_1.default, extractRequest_1.extractRequest(slider_2.SliderSchema), slider_1.default.getAllSliderImages);
exports.sliderRouter.delete('/api/v1/admin/slider/delete/:id', extractAdminJWT_1.default, extractRequest_1.extractRequest(slider_2.SliderSchema), slider_1.default.deleteSliderImage);
