...
exports.cartRouter.put("/api/v1/user/customer/cart/update/:id", extractCustomerJWT_1.default, extractRequest_1.extractRequest(cart_2.CartSchema), cart_1.default.updateFromCart);
exports.cartRouter.delete("/api/v1/user/customer/cart/delete/:id", extractCustomerJWT_1.default, cart_1.default.deleteFromCart);
