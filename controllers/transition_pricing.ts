...
const addTransitionPricing = (req: Request, res: Response, next: NextFunction) =>{
...
const deleteTransitionPricing = (req: Request, res: Response, next: NextFunction) =>{
    let {id} = req.params;
...
const updateTransitionPricing = (req: Request, res: Response, next: NextFunction) =>{
    let {id} = req.params;
    let {from_city, to_city, price} = req.body;
...
const getAllTransitionsPricing = (req: Request, res: Response, next: NextFunction) =>{
...
export default {addTransitionPricing, deleteTransitionPricing, updateTransitionPricing, getAllTransitionsPricing};