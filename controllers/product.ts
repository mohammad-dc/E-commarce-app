...
const getAllProducts = (req: Request, res: Response, next: NextFunction) =>{
    let query = `SELECT ID, dealer_id, name, image, price, description FROM product`;
...
const getAllDealerProducts = (req: Request, res: Response, next: NextFunction) =>{
...
export default {addProduct, updateProducts, deleteProduct, getAllProducts, getAllDealerProducts, searchProduct};